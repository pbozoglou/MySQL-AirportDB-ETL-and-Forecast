...
where t2.from_airport_id in (select airport_id from dim_airports) and (t1.last_updated > now() - interval 7 day)
on duplicate key update
	booking_id = t1.booking_id,
    flight_key = t2.flight_key,
    passenger_key = t3.passenger_key,
    departure_airport_key = t4.airport_key,
    date_key = t5.date_key,
    time_key = t6.time_key,
    price = t1.price,
